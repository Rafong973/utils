...
// 个位数转10位数
const digitsToTens = (val = 0) => {
  if (getType(val) !== 'Number') return val
  return val <= 9 ? `0${val}` : val
};

export { assemblyUrlQuery, captureName, checkPhone, checkWebsiteUrl, dataURLtoBlob, digitsToTens, getType, getUrlHashQuery, getUrlQuery, isNull, isNullArray, isNullNum, isNullStr, isNullSymbol, loadScript, phoneDesensitizationTreatment, toHump, wait };
